...
You're in the mid stages of a sales process with a qualified prospect.  Does this kind of conversation sound familiar?
**Prospect**
...
If you have a certain version of an informational guide that is used in a well defined structure for a given part of the sales process, then you can begin to test other versions against an established baseline for that stage.  This approach is particularly easy to manage and track if you use a flexible CRM tool like [Pipedrive][2] which lets you view progress from one stage to another and set up custom fields in a customer record to tag which version of a piece of content they saw… from which you can analyse correlations.
**B.4. Street Cred**
...
Within a static piece of content, you are able to precisely control language and styling.  Even if we (humans, that is) are focusing on the information we cannot help but notice how it is delivered to us: Nicely with style or not nicely without style.
...
This process is something I take clients through regularly, if you are interested please reach out to me and I can give you some more ideas about how to go about it for your context.
...
If you’re not sure how to help your team produce the kind of content assets that’s going to deliver the value I’ve outlined here.  I can help you through training and workshops to get everyone pulling in the right direction.

[^1]:	Progressive profiling is the gradual accumulation of data about a prospect from their first interaction with one of your your digital assets (e.g. website, social profile, guide download) to build  a picture of them.  Every interaction they have with any asset in your digital estate can be linked into a single dataset, even when they are a total stranger to you.

[2]:	https://www.pipedrive.com/register?promocode=pdp-c